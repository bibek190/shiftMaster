  ...
  return (
    <div style={{ marginTop: 80, padding: 10 }}>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to shiftmaster, the software
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Vision software, 52 Coningham st, Gowrie,
            ACT 2904.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Country</strong> refers to: Australian Capital Territory,
            Australia
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to shiftmaster, accessible from{" "}
            <a
              href="http://shiftmaster.com.au/"
              rel="external nofollow noopener"
              target="_blank"
            >
              http://shiftmaster.com.au/
            </a>
          </p>
        </li>
        <li>
